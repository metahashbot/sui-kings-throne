...
{
	[TypeInfoBox("聚变反应——【超载】 = 电 + 灵")]
	[Serializable]
	public class Buff_超载_ElementOverload : BaseRPBuff, I_BuffAsElementSecond , I_BuffAsElementFusion,
		I_BuffContainOnetimeVFXOnInitializeOrRefreshed
	{
		...
		[SerializeField, LabelText("追加的【灵】伤害相较于此次伤害的百分比")]
		[TitleGroup("===基本配置===")]
		protected float _soulDamageBonusRatio = 50f;
		...
		public override DS_ActionBusArguGroup OnBuffInitialized(List<BaseBuffLogicPassingComponent> blps)
		{
			...
			if (damageBLP == null)
			{
				Debug.LogError("Buff_超载_ElementCrush: OnBuffInitialized: 未找到伤害信息");
				return ds;
			}
			...
			var newDamage_huo = RP_DS_DamageApplyInfo.BuildDamageApplyInfoFromRuntime(
				Parent_SelfBelongToObject as I_RP_Damage_ObjectCanReceiveDamage,
				damageBLP.RelatedDamageResultInfoRef.Caster,
				DamageTypeEnum.LingNengLing_灵能灵,
				damageBLP.RelatedDamageResultInfoRef.DamageResult_TakenOnHP * _soulDamageBonusRatio / 100f,
				DamageProcessStepOption.AppendDamageDPS());
