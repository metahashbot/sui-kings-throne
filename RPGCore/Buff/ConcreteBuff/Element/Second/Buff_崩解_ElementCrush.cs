...
{
	[TypeInfoBox("聚变反应：崩解【电+光】，屏蔽盾构")]
	[Serializable]
	public class Buff_崩解_ElementCrush : BaseRPBuff, I_BuffAsElementSecond, I_BuffAsElementFusion,
		I_BuffContainOnetimeVFXOnInitializeOrRefreshed
	{

		[SerializeField, LabelText("追加的电伤害相较于此次伤害的百分比")]
		[TitleGroup("===基本配置===")]
		protected float _electricDamageBonusRatio = 50f;

		[SerializeField, LabelText("追加的光伤害相较于此次伤害的百分比")]
		[TitleGroup("===基本配置===")]
		protected float _lightDamageBonusRatio = 50f;
		...
		public override DS_ActionBusArguGroup OnBuffInitialized(List<BaseBuffLogicPassingComponent> blps)
		{
			...
			if (damageBLP == null)
			{
				Debug.LogError("Buff_崩解_ElementCrush: OnBuffInitialized: 未找到伤害信息");
				return ds;
			}
			...
			var newDamage_huo = RP_DS_DamageApplyInfo.BuildDamageApplyInfoFromRuntime(
				...
				damageBLP.RelatedDamageResultInfoRef.DamageResult_TakenOnHP * _lightDamageBonusRatio / 100f,
				DamageProcessStepOption.AppendDamageDPS());
