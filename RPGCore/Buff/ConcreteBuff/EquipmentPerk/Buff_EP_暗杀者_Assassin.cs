...
{
	[Serializable]
	public class Buff_EP_暗杀者_Assassin : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		[Serializable]
		public struct BuffData
		{
			...
			[SerializeField, LabelText("攻击提升百分比"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfNeedAppend(DS_ActionBusArguGroup ds)
		{
			...
			blp_.TargetEntry = RP_DataEntry_EnumType.AttackPower_攻击力;
			blp_.CalculatePosition = ModifyEntry_CalculatePosition.FrontMul;
			blp_.ModifyValue = CurrentDamageBonusPercent;
