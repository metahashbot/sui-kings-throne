...
{
	[Serializable]
	public class Buff_EP_悲亡者_Sorrowful : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		[Serializable]
		public struct BuffData
		{
			...
			[SerializeField, LabelText("敏捷提升百分比"), SuffixLabel("%")]
			public float DEXBonusPercent;
		}
		...
		public float CurrentDEXBonusPercent { get; private set; }
		...
		private void _ABC_CheckIfNeedAppend(DS_ActionBusArguGroup ds)
		{
			...
			blp_.TargetEntry = RP_DataEntry_EnumType.M_Dexterity_主敏捷;
			blp_.CalculatePosition = ModifyEntry_CalculatePosition.FrontMul;
			blp_.ModifyValue = CurrentDEXBonusPercent;
		...
		protected override void ProcessPerBLP(BaseBuffLogicPassingComponent blp)
		{
			...
			switch (blp)
			{
				case BLP_作为Perk的等级_ActAsPerkLevel perkLevel:
					...
					CurrentDEXBonusPercent = buffData.DEXBonusPercent;
