...
{
	[Serializable]
	public class Buff_EP_电极卫_ElectrodeDefense : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		...
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("电伤害减少百分比，于抵抗计算后,过盾计算前"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfNeedReduceDamage(DS_ActionBusArguGroup ds)
		{
			...
			if (dar.DamageType != DamageTypeEnum.YuanNengDian_源能电)
			{
				return;
			}
