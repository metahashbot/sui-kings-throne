...
{
	[Serializable]
	public class Buff_EP_连环追击体质_ChainStrikeConstitution : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		...
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("追加体质百分比,40就是体质的40%"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfAppendDamage(DS_ActionBusArguGroup ds)
		{
			...
			float value = _entry_VIT.CurrentValue * (AppendPartial / 100f);
