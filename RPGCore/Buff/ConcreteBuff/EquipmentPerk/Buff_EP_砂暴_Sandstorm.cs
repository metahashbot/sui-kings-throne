...
{
	[Serializable]
	public class Buff_EP_砂暴_Sandstorm : BaseRPBuff
	{
		[Serializable]
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("土系技能伤害增加百分比"), SuffixLabel("%")]
			public float DamageBonus_EarthSkill;
		}
		...
		private void _ABC_CheckIfNeedAddDamage(DS_ActionBusArguGroup ds)
		{
			...
			if (!dar.DamageFromTypeFlags.HasFlag(DamageFromTypeFlag.PlayerSkillAttack_玩家技能伤害) ||
			    dar.DamageType != DamageTypeEnum.AoNengTu_奥能土)
			{
				return;
			}
		...
		protected override void ProcessPerBLP(BaseBuffLogicPassingComponent blp)
		{
			...
			switch (blp)
			{
				case BLP_作为Perk的等级_ActAsPerkLevel perkLevel:
					...
					CurrentDamageBonus = buffData.DamageBonus_EarthSkill;
					break;
			}
		}
