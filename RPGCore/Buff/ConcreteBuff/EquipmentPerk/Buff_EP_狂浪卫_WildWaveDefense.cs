...
{
	[Serializable]
	public class Buff_EP_狂浪卫_WildWaveDefense : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		...
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("水伤害减少百分比，于抵抗计算后,过盾计算前"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfNeedReduceDamage(DS_ActionBusArguGroup ds)
		{
			...
			if (dar.DamageType != DamageTypeEnum.AoNengShui_奥能水)
			{
				return;
			}
