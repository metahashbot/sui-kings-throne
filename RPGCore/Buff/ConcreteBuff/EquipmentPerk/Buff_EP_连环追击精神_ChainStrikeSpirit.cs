...
{
	[Serializable]
	public class Buff_EP_连环追击精神_ChainStrikeSpirit: BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		...
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("追加精神百分比,40就是精神的40%"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfAppendDamage(DS_ActionBusArguGroup ds)
		{
			...
			float value = _entry_SPR.CurrentValue * (AppendPartial / 100f);
