...
{
	[Serializable]
	public class Buff_EP_嚎哭者_Howl : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		[Serializable]
		public struct BuffData
		{
			...
			[SerializeField, LabelText("力量提升百分比"), SuffixLabel("%")]
			public float STRBonusPercent;
		}
		...
		public float CurrentSTRBonusPercent { get; private set; }
		...
		private void _ABC_CheckIfNeedAppend(DS_ActionBusArguGroup ds)
		{
			...
			blp_.TargetUID = "Perk嚎哭者";
			blp_.TargetEntry = RP_DataEntry_EnumType.M_Strength_主力量;
			blp_.CalculatePosition = ModifyEntry_CalculatePosition.FrontMul;
			blp_.ModifyValue = CurrentSTRBonusPercent;
		...
		protected override void ProcessPerBLP(BaseBuffLogicPassingComponent blp)
		{
			...
			switch (blp)
			{
				case BLP_作为Perk的等级_ActAsPerkLevel perkLevel:
					...
					CurrentSTRBonusPercent = buffData.STRBonusPercent;
