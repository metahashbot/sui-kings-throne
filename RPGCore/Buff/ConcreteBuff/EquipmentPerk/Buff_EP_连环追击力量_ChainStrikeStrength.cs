...
{
	[Serializable]
	public class Buff_EP_连环追击力量_ChainStrikeStrength : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		...
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("追加力量百分比,40就是力量的40%"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfAppendDamage(DS_ActionBusArguGroup ds)
		{
			...
			float value = _entry_STR.CurrentValue * (AppendPartial / 100f);
