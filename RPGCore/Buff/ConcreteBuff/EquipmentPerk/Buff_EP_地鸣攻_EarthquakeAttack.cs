...
{
	[Serializable]
	public class Buff_EP_地鸣攻_EarthquakeAttack : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		...
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("土伤害增加百分比，于伤害信息构建时"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfNeedAddDamage(DS_ActionBusArguGroup ds)
		{
			...
			if (dar.DamageType != DamageTypeEnum.AoNengTu_奥能土)
			{
				return;
			}
