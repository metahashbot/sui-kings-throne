...
{
	[Serializable]
	public class Buff_EP_连环追击敏捷_ChainStrikeAgility: BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		...
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("追加敏捷百分比,40就是敏捷的40%"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfAppendDamage(DS_ActionBusArguGroup ds)
		{
			...
			float value = _entry_DEX.CurrentValue * (AppendPartial / 100f);
