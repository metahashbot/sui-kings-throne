...
{
	[Serializable]
	public class Buff_EP_魔物天敌_MonsterNemesis : BaseRPBuff, I_BuffCanAsEquipmentPerk
	{
		...
		public struct BuffData
		{
			...
			public int Level;
			[SerializeField, LabelText("对魔物伤害的修正百分比"), SuffixLabel("%")]
		...
		private void _ABC_CheckIfNeedAddDamage(DS_ActionBusArguGroup ds)
		{
			...
			if (dar.Caster.ApplyDamage_CheckTargetBuff(RolePlay_BuffTypeEnum._EnemyTag_Monster_魔物敌人) !=
