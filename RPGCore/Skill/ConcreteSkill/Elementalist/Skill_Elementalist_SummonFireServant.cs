...
// 	[Serializable]
// 	[TypeInfoBox("召唤火傀儡")]
// 	public class Skill_Elementalist_SummonFireServant : Skill_SummonServantBase
// 	{
// 		[SerializeField, LabelText("灼烧光环-Buff 类型"), FoldoutGroup("配置", true),
// 		 TitleGroup("配置/配置", Alignment = TitleAlignments.Centered)]
// #if UNITY_EDITOR
// 		[InlineButton("@PeekBuffConfig(_fireDotAuraBuffType)", "瞅一眼")]
// #endif
// 		protected RolePlay_BuffTypeEnum _fireDotAuraBuffType = RolePlay_BuffTypeEnum.Aura_SimpleFireAura_简单灼烧光环;
//
...
// 				{
// 					DamageType = DamageTypeEnum.AoNengHuo_奥能火,
...
// 				},
// 				CurrentAffectRange = 5,
// 				CurrentAffectInterval = 1,
// 				CurrentAffctFaction = FactionTypeEnumFlag.Enemy_敌人
// 			};
//
//
//
...
// 		{
// 			var su = base.SummonedBehaviourAppear();
// 			var summoned = su.BehaviourRef;
//
// 			SyncWithSelfData(summoned);
// 			summoned.ReceiveBuff_TryApplyBuff(_fireDotAuraBuffType, summoned, summoned, _blp_AuraBuild);
// 			var auraBuff =
// 				summoned.ApplyBuff_GetRelatedBuff(RolePlay_BuffTypeEnum.Aura_SimpleFireAura_简单灼烧光环) as
// 					Buff_CommonAuraBase;
...
// 		// 	bool isSelf = _Internal_CheckIfBreakAnimationIsSelf(occupySourceInfo);
// 		// 	switch (_skillState)
// 		// 	{
// 		// 		case SkillStateTypeEnum.Releasing_施法中:
// 		// 			switch (fixedType)
